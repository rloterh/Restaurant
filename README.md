...
# Restaurant Page - Vanilla JavaScript (Microverse JavaScript Module)

![Microverse](https://img.shields.io/badge/-Microverse-007bff?style=for-the-badge)

## Description
The rubric of this project is to build a Restaurant web page using vanilla javascript. BurgerBest is a demo responsive Restaurant website build from this project. It contains a simple homepage, a menu page, and a contact page. The specification for this project is a part of The Odin Project.
...
## Live Demo
[BurgerBest Restaurant page live demo](https://stupefied-williams-4dcb10.netlify.app/)


## App Screenshot
![img](https://user-images.githubusercontent.com/12745474/116016761-8b91d580-a635-11eb-9992-4271aae78a17.jpg)
...
1. - Copy the git link `https://github.com/rloterh/Restaurant.git` of this project
2. - In your terminal run the command `git clone https://github.com/rloterh/Restaurant.git`
3. - Navigate to the cloned project directory
4. - Run the command `npm init` to setup webpack and project dependencies
...
Feel free to check the [issues page](https://github.com/rloterh/Restaurant/issues).
