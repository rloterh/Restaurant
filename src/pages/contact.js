...
const contactForm = () => {
  ...
  e.formGroupOne.appendChild(Object.assign(e.email, { type: 'email', placeholder: 'Email' })).classList = 'form-control';
  e.contactForm.appendChild(e.formGroupTwo).className = 'form-group my-2';
  e.formGroupTwo.appendChild(Object.assign(e.message, {
    rows: '3',
    placeholder: 'Message',
